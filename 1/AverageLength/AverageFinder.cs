...
namespace AverageLength
{
    ...
    internal class AverageFinder
    {
        ...
        public string[] SplitWords(string text)
        {
            ...
            {
                throw new NullReferenceException("Параметр не может быть пустым или null.");
            }
        ...
        public double FindAverage(string[] words)
        {
            if (words is null)
            {
                throw new NullReferenceException("Параметр не может быть null.");
            }
